...
export default function StaffLoginPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Funcionário entra sempre em /staff (que redireciona pro admin com permissões reduzidas)
      router.push('/staff');
    } catch {
      ...
      <div className="relative w-full max-w-md">
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-brand-cyan-500 to-brand-cyan-700 shadow-glow-cyan flex items-center justify-center">
            ...
            <div>
              ...
              <h1 className="text-2xl font-display font-bold leading-tight">Login operação</h1>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="off"
                  spellCheck={false}
                  className="w-full h-12 pl-10 pr-3 rounded-xl bg-bg-elevated border border-border text-text-primary placeholder:text-text-muted focus:border-brand-cyan-400 outline-none"
          ...
          <p className="text-[11px] text-text-subtle text-center mt-5 leading-relaxed">
            Acesso restrito à equipe. Credenciais configuradas via variáveis de ambiente.
          </p>

          <div className="mt-4 pt-4 border-t border-border-subtle">
            <a
              href="/admin/login"
              className="block text-center text-[11px] text-text-muted hover:text-text-primary transition"
            >
              Você é administrador? Entre em /admin/login
            </a>
          </div>
        </motion.div>
      </div>
