...
export function seedIfEmpty(db: Schema): Schema {
  ...
  if (db.products.length === 0) {
    db.products = [
      {
        id: 'cp-001', name: 'Mini Projetor LED Portátil 4K', niche: 'Eletrônicos', plan: 'basic',
        image: 'https://images.unsplash.com/photo-1626387346567-68d0c1d6f8f0?w=1200&q=80',
        coverImage: 'https://images.unsplash.com/photo-1626387346567-68d0c1d6f8f0?w=800&q=80',
        ...
        tags: ['high-ticket', 'demo'],
        description: 'Produto explosivo de eletrônicos. Funciona com demos em ambiente escuro.',
        videoTranscription: 'Você sabia que dá pra transformar qualquer parede em uma TV gigante por menos de R$ 200? Esse mini projetor portátil tem qualidade 4K, conecta no celular e cabe na palma da mão. Eu testei e o resultado é absurdo. Comenta PROJETOR aqui embaixo que eu te mando o link.',
        period: 'today', createdAt: now,
      },
      {
        id: 'cp-002', name: 'Kit Skincare Premium Coreano', niche: 'Beleza', plan: 'pro',
        ...
        rankingTrend: 'up', rankingPosition: 2, salesEstimate: 1920, revenueEstimate: 96000, commission: 30,
        videoExampleUrl: 'https://www.tiktok.com/@example/video/2',
        imagePromptUrl: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=1200&q=80',
        affiliateUrl: 'https://shop.tiktok.com/cp-002',
        gptAgentUrl: 'https://chatgpt.com/g/influlab-script',
        flowUrl: 'https://labs.google/flow',
        tags: ['skincare', 'aesthetic'],
        description: 'Kit completo de skincare coreano premium com 5 passos.',
        videoTranscription: 'Em 30 dias minha pele mudou completamente. Esse kit tem 5 passos: limpeza, tônico, sérum, hidratante e protetor. Cada um trabalha uma camada diferente. Comenta SKIN que eu te mando.',
        period: 'today', createdAt: now,
      },
      {
        id: 'cp-003', name: 'Luminária Galáxia 360° Bluetooth', niche: 'Decoração', plan: 'basic',
        ...
        flowUrl: 'https://labs.google/flow',
        tags: ['decor', 'ambient'],
        description: 'Vídeos noturnos mostrando o efeito 360° funcionam muito bem.',
        videoTranscription: 'Transforma qualquer quarto em uma galáxia. Conecta no Bluetooth, toca música, e o teto inteiro vira espaço.',
        period: 'today', createdAt: now,
      },
      {
        id: 'cp-004', name: 'Escova Alisadora Térmica 3 em 1', niche: 'Beleza', plan: 'pro',
        ...
        description: 'Demonstração em cabelo real é o gatilho.',
        videoTranscription: 'Penteia, alisa e dá brilho — tudo em um aparelho só. Olha o antes e depois.',
  ...
  if (db.videoPrompts.length === 0) {
    db.videoPrompts = [
      {
        id: 'vp-001', title: 'UGC Demonstração de Produto',
        videoUrl: sampleVideo1,
        thumb: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=600&q=80',
        promptFlow: 'Vídeo UGC vertical 9:16 de uma jovem segurando o produto com luz natural, expressão genuína de surpresa, lifestyle, 4K, smartphone POV, 8 segundos.',
        promptCreate: 'POV vertical 9:16, jovem mulher segurando produto, iluminação natural de janela, expressão de descoberta, ambiente cozinha aesthetic, 8 segundos.',
        category: 'UGC', niche: 'Universal', views: 12400, duration: '0:08',
        createdAt: now,
      },
      {
        id: 'vp-002', title: 'Antes & Depois com Reveal',
        videoUrl: sampleVideo2,
        thumb: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&q=80',
        promptFlow: 'Split-screen mostrando "antes" e "depois", transição com flash branco, produto aparecendo no centro, 6 segundos.',
        promptCreate: 'Cinemagraph 9:16 dividido ao meio: lado esquerdo dessaturado/estático, lado direito vibrante/em movimento, transição com fade luminoso central, 6 segundos.',
  ...
  if (db.virals.length === 0) {
    db.virals = [
      {
        id: 'vv-001', title: 'POV: O segredo que ninguém te contou',
        videoUrl: sampleVideo1,
        thumb: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=600&q=80',
  ...
  if (!db.platformMappings) db.platformMappings = [];
